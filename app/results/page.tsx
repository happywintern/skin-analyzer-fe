      ...
      <div className="flex-1 px-6 py-4 max-w-2xl mx-auto w-full pb-16">
        ...
        >
          <div className="flex items-center justify-between mb-5">
            ...
            <span className="text-xs text-bark font-light">{result.ingredients.length} found</span>
          </div>
        ...
        >
          <p className="text-xs text-bark font-light leading-relaxed text-center">
            These results are generated by an AI model and are for informational purposes only.
