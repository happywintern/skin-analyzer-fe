...
export const metadata: Metadata = {
  ...
  description: "Understand your skin. Personalized ingredient recommendations powered by AI.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body className="bg-cream text-deep font-body antialiased">{children}</body>
    </html>
  );
}
